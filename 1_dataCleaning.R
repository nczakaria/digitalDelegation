...
dat <- read_csv("finalData.csv",show_col_types = FALSE)
my.dat <- dat
...
DigitalDelegation <- function(x.dataset)
{
  ...
  x.dataset$FinanceLoginInstitution <- NA
  ...
  x.dataset$MedicalLoginInstitution <- NA
...
# write to file
## SG
write.csv(test.data.sg, file = "test.data.sg.csv", row.names = FALSE)
write.csv(sg_filtered_data, file = "sg_filtered_data.csv", row.names = FALSE)
write.csv(test.data.sg.plot, file = "test.data.sg.plot.csv", row.names = FALSE)
write.csv(sg_filtered_data_plot, file = "sg_filtered_data_plot.csv", row.names = FALSE)
## US
write.csv(test.data.us, file = "test.data.us.csv", row.names = FALSE)
write.csv(us_filtered_data, file = "us_filtered_data.csv", row.names = FALSE)
write.csv(test.data.us.plot, file = "test.data.us.plot.csv", row.names = FALSE)
write.csv(us_filtered_data_plot, file = "us_filtered_data_plot.csv", row.names = FALSE)
